...
describe('Pricing', () => {
  ...
  //     let isBuy = true;
  //     let args = await instance.fromPool(isBuy);
  ...
  //     args = await instance.fromPool(!isBuy);
  ...
  //     await underlying.connect(lp).approve(instance.address, collateral);

  //     await instance
  //       .connect(lp)
  //       .deposit(
  //         position,
  //         await instance.getNearestTickBelow(lower),
  //         await instance.getNearestTickBelow(upper),
  //         collateral,
  //         0,
  //         0,
  //       );
