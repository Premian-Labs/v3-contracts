...
abstract contract UnderwriterVaultInternalTest is UnderwriterVaultDeployTest {
    ...
    function test_afterBuy_Success() public {
        ...
        vm.expectEmit();
        emit PerformanceFeePaid(feeReceiver, scaleDecimalsFrom(spread * ud(0.05e18)));
        ...
        assertEq(totalAssets, scaleDecimalsFrom(initialTotalAssets + premium + spread * ud(0.95e18)));
    ...
    function test_settleMaturity_Success() public {
        ...
        assertEq(vault.totalAssets(), scaleDecimalsFrom(assetsAfterMint));
        ...
        assertApproxEqAbs(
            vault.totalAssets(),
            scaleDecimalsFrom(isCallTest ? ud(9.3153333e18) : ud(8976e18)),
            0.0000001e18
        );
