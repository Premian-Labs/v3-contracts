...
abstract contract UnderwriterVaultVaultTest is UnderwriterVaultDeployTest {
    ...
    function test_trade_ProcessTradeCorrectly() public {
        ...
        uint256 mintingFee = pool.takerFee(address(0), tradeSize, toTokenDecimals(ud(0.03 ether) * tradeSize), true);
    ...
    function test_trade_AnnihilateFor_ProcessTradeCorrectly() public {
        ...
        uint256 fee = pool.takerFee(users.trader, size, toTokenDecimals(ud(0.03 ether) * size), true);
    ...
    function test_trade_UseLongReceiverAsTaker() public {
        ...
        UD60x18 tradeSize = ud(3e18);
        uint256 fee = pool.takerFee(users.trader, tradeSize, toTokenDecimals(ud(0.03 ether) * tradeSize), true);
