...
abstract contract PoolSmokeSpamTest is DeployTest {
    ...
    function test_SmokeBig_SemiLargeNumbers() public {
        _setup_SmokeBig();
        _test_SmokeBig_SemiLargeNumbers();
    }

    function test_SmokeBig_LargeNumbers() public {
        _setup_SmokeBig();
        _test_SmokeBig_LargeNumbers();
    }

    function test_SmokeBig_VeryLargeNumbers() public {
        _setup_SmokeBig();
        _test_SmokeBig_VeryLargeNumbers();
    }

    function _test_SmokeBig_SemiLargeNumbers() internal {
        uint256 size;
    ...
    function _test_SmokeBig_LargeNumbers() internal {
        uint256 size;
        bool isBidIfStrandedMarketPrice;
        size = 1000000000000 ether;
        posKey.owner = traders.trader5;
        posKey.operator = traders.trader5;
        posKey.lower = ud(0.193000000000000000 ether);
        posKey.upper = ud(0.318000000000000000 ether);
        ...
        depositS(size, isBidIfStrandedMarketPrice);
        vm.stopPrank();
        size = 1852500000000 ether;
        vm.startPrank(traders.trader3);
        tradeS(size, true);
        vm.stopPrank();
        size = 3707375000000 ether;
        vm.startPrank(traders.trader1);
        tradeS(size, false);
        vm.stopPrank();
        size = 185368750000 ether;
        vm.startPrank(traders.trader4);
        tradeS(size, false);
        vm.stopPrank();
        size = 3790731562500 ether;
        vm.startPrank(traders.trader2);
        tradeS(size, true);
        vm.stopPrank();
        size = 1000000000000 ether;
        ...
        depositS(size, isBidIfStrandedMarketPrice);
        vm.stopPrank();
        size = 189536578125 ether;
        vm.startPrank(traders.trader4);
        tradeS(size, true);
        vm.stopPrank();
        size = 4740523171093 ether;
        vm.startPrank(traders.trader8);
        tradeS(size, false);
        vm.stopPrank();
        size = 1000000000000 ether;
        ...
        withdrawS(posKey, size);
        vm.stopPrank();
        size = 1128936553465 ether;
        vm.startPrank(traders.trader5);
        tradeS(size, true);
        vm.stopPrank();
        size = 56446827673 ether;
        vm.startPrank(traders.trader9);
        tradeS(size, true);
        vm.stopPrank();
        size = 2822341383 ether;
        vm.startPrank(traders.trader0);
        tradeS(size, true);
        vm.stopPrank();
        size = 5699858882930 ether;
        vm.startPrank(traders.trader0);
        tradeS(size, false);
        vm.stopPrank();
        size = 284992944146 ether;
        vm.startPrank(traders.trader0);
        tradeS(size, false);
        vm.stopPrank();
        size = 5685750352792 ether;
        vm.startPrank(traders.trader2);
        tradeS(size, true);
        vm.stopPrank();
        size = 284287517639 ether;
        vm.startPrank(traders.trader2);
        tradeS(size, true);
        vm.stopPrank();
        size = 1000000000000 ether;
        ...
        depositS(size, isBidIfStrandedMarketPrice);
        vm.stopPrank();
        size = 5700000000000 ether;
        vm.startPrank(traders.trader3);
        tradeS(size, false);
        vm.stopPrank();
        size = 284999999999 ether;
        vm.startPrank(traders.trader9);
        tradeS(size, false);
        vm.stopPrank();
        size = 14249999999 ether;
        vm.startPrank(traders.trader8);
        tradeS(size, false);
        vm.stopPrank();
        size = 1000000000000 ether;
    ...
    function _test_SmokeBig_VeryLargeNumbers() internal {
        uint256 size;
        bool isBidIfStrandedMarketPrice;
        size = 1000000000000000 ether;
        posKey.owner = traders.trader5;
        posKey.operator = traders.trader5;
        posKey.lower = ud(0.193000000000000000 ether);
        posKey.upper = ud(0.318000000000000000 ether);
        ...
        depositS(size, isBidIfStrandedMarketPrice);
        vm.stopPrank();
        size = 1852500000000000 ether;
        vm.startPrank(traders.trader3);
        tradeS(size, true);
        vm.stopPrank();
        size = 3707375000000000 ether;
        vm.startPrank(traders.trader1);
        tradeS(size, false);
        vm.stopPrank();
        size = 185368750000000 ether;
        vm.startPrank(traders.trader4);
        tradeS(size, false);
        vm.stopPrank();
        size = 3790731562500000 ether;
        vm.startPrank(traders.trader2);
        tradeS(size, true);
        vm.stopPrank();
        size = 1000000000000000 ether;
        ...
        depositS(size, isBidIfStrandedMarketPrice);
        vm.stopPrank();
        size = 189536578125000 ether;
        vm.startPrank(traders.trader4);
        tradeS(size, true);
        vm.stopPrank();
        size = 4740523171093750 ether;
        vm.startPrank(traders.trader8);
        tradeS(size, false);
        vm.stopPrank();
        size = 1000000000000000 ether;
        ...
        withdrawS(posKey, size);
        vm.stopPrank();
        size = 1128936553465177 ether;
        vm.startPrank(traders.trader5);
        tradeS(size, true);
        vm.stopPrank();
        size = 56446827673258 ether;
        vm.startPrank(traders.trader9);
        tradeS(size, true);
        vm.stopPrank();
        size = 2822341383662 ether;
        vm.startPrank(traders.trader0);
        tradeS(size, true);
        vm.stopPrank();
        size = 5699858882930816 ether;
        vm.startPrank(traders.trader0);
        tradeS(size, false);
        vm.stopPrank();
        size = 284992944146540 ether;
        vm.startPrank(traders.trader0);
        tradeS(size, false);
        vm.stopPrank();
        size = 5685750352792672 ether;
        vm.startPrank(traders.trader2);
        tradeS(size, true);
        vm.stopPrank();
        size = 284287517639633 ether;
        vm.startPrank(traders.trader2);
        tradeS(size, true);
        vm.stopPrank();
        size = 1000000000000000 ether;
        ...
        depositS(size, isBidIfStrandedMarketPrice);
        vm.stopPrank();
        size = 5700000000000000 ether;
        vm.startPrank(traders.trader3);
        tradeS(size, false);
        vm.stopPrank();
        size = 284999999999999 ether;
        vm.startPrank(traders.trader9);
        tradeS(size, false);
        vm.stopPrank();
        size = 14249999999999 ether;
        vm.startPrank(traders.trader8);
        tradeS(size, false);
        vm.stopPrank();
        size = 1000000000000000 ether;
